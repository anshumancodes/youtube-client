...
const BottomNav= () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 border-t right-0 bg-[#0f0f0f]  py-2">
      <div className="flex justify-around items-center">
        ...
        <NavButton
          ...
          label="Videos"
        />
      {profile? (  <Link to={"/library"}><ProfileButton profileImg={profile.avatar} /></Link>): (<a className="flex flex-col" href="/notsignedin"><UserCircle/> you</a>)}
      </div>
    </nav>
  );
};
